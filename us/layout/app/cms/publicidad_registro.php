...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        if(empty($name))
        {
            $errors .= "\n Nombre es obligatorios. ";
        }
        if(empty($visitor_email))
        {
            $errors .= "\n Email es obligatorios. ";
        }
        if(empty($site))
        {
            $errors .= "\n Sitio es obligatorios. ";
        }
        if(empty($contact))
        {
            $errors .= "\n Teléfono es obligatorios. ";
        }
        ...
        if(empty($errors))
        {
            //send the email
            $to = $your_email;
            $subject="Registro para Publicidad";
            $from = $your_email;
...
?>
<div id="emailformtitle">Registre su empresa</div>
...
<script language="JavaScript">
    ...
    frmvalidator.addValidation("site","req","Por favor escriba su url sitio.");
    frmvalidator.addValidation("contact","req","Por favor escriba su contacto.");
</script>
