...
<div id="footer_container">
    <div id="footer_col1">
        ...
        $footer = new FooterList();
        $where = "source";
        $like = "'CMS_TITLE' AND language LIKE 'pt'";
        $order = "`order`";
    ...
    <div id="footer_col2">
        ...
        $footer = new FooterList();
        $where = "source";
        $like = "'SUPPORT_TITLE' AND language LIKE 'pt'";
        $order = "`order`";
        $footer->setWhere($where);
        $footer->setLike($like);
        $footer->setOrder($order);
        ...
        $footer = new FooterList();
        $where = "source";
        $like = "'SUPPORT' AND language LIKE 'pt'";
        $order = "`order`";
        $footer->setWhere($where);
        $footer->setLike($like);
        $footer->setOrder($order);
    ...
    <div id="footer_col3">
        ...
        $footer = new FooterList();
        $where = "source";
        $like = "'BUSINESS_TITLE' AND language LIKE 'pt'";
        $order = "`order`";
        $footer->setWhere($where);
        $footer->setLike($like);
        $footer->setOrder($order);
        ...
        $footer = new FooterList();
        $where = "source";
        $like = "'BUSINESS' AND language LIKE 'pt'";
        $order = "`order`";
        $footer->setWhere($where);
        $footer->setLike($like);
        $footer->setOrder($order);
